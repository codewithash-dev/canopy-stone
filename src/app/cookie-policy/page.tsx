    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          <p className="text-sm uppercase tracking-[0.3em] text-[#A67C52] mb-4">Cookie Policy</p>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Cookie Policy</h1>
          <p className="text-lg text-gray-700">
            This policy describes how cookies and similar technologies are used on our website.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 space-y-8 text-gray-700">
          <div>
            ...
            <p>Cookies are small files stored on your device that help websites remember preferences and activity.</p>
          </div>
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">How We Use Cookies</h2>
            <p>We use cookies for essential site functionality, analytics, and to improve the user experience.</p>
          </div>
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Managing Preferences</h2>
            <p>You can modify your browser settings to accept, block, or delete cookies at any time.</p>
          </div>
        </div>
      </section>
