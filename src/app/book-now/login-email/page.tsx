...
export default function LoginEmailPage() {
  ...
  const handleSignIn = (e: React.FormEvent) => {
    ...
    localStorage.setItem('user', JSON.stringify({ email: email.trim(), name: email.trim() }));
        ...
        <div className="w-full lg:w-[60%] bg-white flex flex-col">
          <div className="px-8 pt-8 pb-6">
            ...
            <div className="max-w-md mx-auto">
              ...
              <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">Login via Email</h1>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Email"
                      className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#A67C52] focus:border-transparent"
                    />
                  </div>
                </div>
