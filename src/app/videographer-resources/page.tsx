...
export default function VideographerResources() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-sm uppercase tracking-[0.3em] text-[#A67C52] mb-4">Videographer Resources</p>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Guides for Our Media Team</h1>
          <p className="text-lg text-gray-700">
            Production standards, shot lists, and delivery guidelines to ensure consistent results.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-6">
          {[
            'HDR Photography shot list',
            'Cinematic video walkthrough guide',
            'Drone safety checklist',
            'Matterport capture workflow',
            'Twilight edit request form',
            ...
            <div key={item} className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 text-sm">Coming soon. Contact us for access to current docs.</p>
            </div>
          ))}
        </div>
      </section>
