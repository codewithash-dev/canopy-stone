    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-sm uppercase tracking-[0.3em] text-[#A67C52] mb-4">Marketing Resources</p>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Tools to Help You Win More Listings</h1>
          <p className="text-lg text-gray-700">
            Downloadable assets, templates, and tips to help you market your listings and your brand.
          </p>
        </div>
      </section>
