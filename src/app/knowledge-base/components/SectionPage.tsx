...
import { getArticlesForSection, type ArticleSection } from '../articles-data';
...
export default function SectionPage({ section, title, description, icon, popularSlugs, introContent }: SectionPageProps) {
          ...
          <aside className="lg:w-80 shrink-0">
            <div className="bg-white border border-gray-200 rounded-lg p-6 sticky top-6">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center shrink-0 [&>svg]:w-5 [&>svg]:h-5 [&>svg]:text-gray-600">
                  {icon}
                </div>
                <div>
